 ...
 * 
 * <p>
 * Copyright: Copyright © 2018 Lynn Robert Carter, Ayush
 * </p>
 * 
...
public class MazeRunner extends Application {
	...
	private Image loadAnImage(String fileName) {
		Image theImage = null;
		try {
			theImage = new Image(fileName);
		}
		// If any of the images is missing or is not reachable a runtime error is displayed on the
		// console
		catch (IllegalArgumentException f) {
			System.out.println("Unable to access the image file <" + fileName + ">!");
			atLeastOneImageNotFound = true;
		}
		return theImage;
	}
